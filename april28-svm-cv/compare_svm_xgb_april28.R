...
save(minC_GSVM, "april28-svm-cv/April28_20features_minC_GSVM.rda")
save(minSigma_GSVM, "april28-svm-cv/April28_20features_minSigma_GSVM.rda")
...
save(min_GSVM, file = "april28-svm-cv/April28_20features_min_GSVM.rda")
save(train_GSVM, file = "april28-svm-cv/April28_20features_train_GSVM.rda")
save(predict_GSVM, file = "april28-svm-cv/April28_20features_predict_GSVM.rda")
